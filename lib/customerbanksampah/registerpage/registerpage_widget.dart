...
class _RegisterpageWidgetState extends State<RegisterpageWidget> {
  ...
  void initState() {
    ...
    _model.addresTextController ??= TextEditingController();
                    ...
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Nomor Whatsapp (88242xxx)',
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.addresTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.register = await RegistercustomerCall.call(
                              ...
                              address: _model.addresTextController.text,
                            ...
                            if ((_model.register?.succeeded ?? true)) {
                              FFAppState().AuthToken =
                                  RegistercustomerCall.authToken(
                                (_model.register?.jsonBody ?? ''),
                              )!;
                              setState(() {});
                              await showDialog(
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return WebViewAware(
                                    child: AlertDialog(
                                      title: const Text('Registrasi Gagal'),
                                      content: const Text('Akun Gagal Terdaftar'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
